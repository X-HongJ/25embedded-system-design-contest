...
Usage:
    ...
    ProfileModels(['yolo11s.yaml', 'yolov8s.yaml']).profile()
...
class ProfileModels:
    ...
    Examples:
        ...
        >>> profiler = ProfileModels(["yolo11s.yaml", "yolov8s.yaml"], imgsz=640)
        >>> profiler.profile()
    """
    ...
    def profile(self):
        ...
        Examples:
            Profile models and print results
            >>> from ultralytics.utils.benchmarks import ProfileModels
            >>> profiler = ProfileModels(["yolo11s.yaml", "yolov8s.yaml"])
