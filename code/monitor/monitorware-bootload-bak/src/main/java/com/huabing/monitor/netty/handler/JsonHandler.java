...
public class JsonHandler extends SimpleChannelInboundHandler {
    ...
    protected void channelRead0(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        if (Objects.isNull(msg)) {
            ...
            if ("update".equals(jsonObject.getString("action")) && "bootload".equals(jsonObject.getString("type"))) {
                // 下发更新指令，让板子跳转bootload
                short mechId = ByteUtils.getShort(new byte[]{jsonObject.getByte("building"), jsonObject.getByte("room_id")});
